...
namespace Proxies\__CG__\Blog\CoreBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Comment extends \Blog\CoreBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Blog\\CoreBundle\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'Blog\\CoreBundle\\Entity\\Comment' . "\0" . 'commentAuthor', '' . "\0" . 'Blog\\CoreBundle\\Entity\\Comment' . "\0" . 'commentAuthorEmail', '' . "\0" . 'Blog\\CoreBundle\\Entity\\Comment' . "\0" . 'commentContent', '' . "\0" . 'Blog\\CoreBundle\\Entity\\Comment' . "\0" . 'created');
        }
